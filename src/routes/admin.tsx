  ...
  return (
    <section>
      ...
      <form
        ...
        onSubmit={async (e) => {
          ...
          const { error } = await supabase.from("photos").insert({
            ...
            photographer_instagram: form.photographer_instagram
              ? form.photographer_instagram.replace(/^@/, "")
              : null,
          });
          if (error) {
      ...
      >
        ...
        <label className={labelCls}>
          Instagram handle (@ இல்லாமல்)
          <input
            value={form.photographer_instagram}
            onChange={(e) => setForm({ ...form, photographer_instagram: e.target.value })}
